...
from models import KGPGATNet, PGATNet

MODEL = 'PGAT'
KG_IM_MODEL = KGPGATNet
IM_MODEL = PGATNet
IMPLICIT = True
STEP_LENGTH = 2
...
dataset += '_{}step'.format(STEP_LENGTH) if STEP_LENGTH else ''
...
dataset_args = {
    ...
    'num_core': args.num_core, 'step_length': STEP_LENGTH, 'train_ratio': args.train_ratio,
    'implicit': IMPLICIT, 'debug': args.debug,
}
model_class = KG_IM_MODEL if args.pretrain else IM_MODEL
